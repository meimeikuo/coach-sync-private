  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 sm:p-6">
      <motion.div 
        ...
        className="bg-white/95 backdrop-blur-xl w-full max-w-md rounded-[2rem] p-6 flex flex-col max-h-[90vh] overflow-y-auto no-scrollbar shadow-[0_0_60px_rgba(0,0,0,0.2)] relative"
      >
        ...
        <div className="space-y-4 flex-1">
          ...
          {!isEditing && !isScheduled && (
            <div className="space-y-3">
              {record?.signedAt && (
                <div className="text-[10px] text-slate-400 border-t border-slate-200/40 pt-2 mt-2">
              ...
              <div>
                ...
                <div className="bg-white rounded-xl h-20 border border-slate-200/60 flex items-center justify-center overflow-hidden relative shadow-sm p-2">
